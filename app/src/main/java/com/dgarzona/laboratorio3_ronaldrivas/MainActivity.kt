package com.dgarzona.laboratorio3_ronaldrivas
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fivecentesImageView = findViewById(R.id.ten_centes_image_view)
        cashTextView = findViewById(R.id.cash_text_view)
        tencentesImageView = findViewById(R.id.five_centes_image_view)
